...
def spotii():
	...
	try:
		ok = raw_input("{}root@BH~# Entre List Email: ".format(fy,sn))
		okd = open(ok, 'r')
	except:
...
def helper4():
  ...
  |______/|____|\____/|_| \_\   |_|   |_||_| \__\ |_|  |_____| 
                                  ...
                                  Script Name : BlckHrtz Site Tester (>y<)
                	Greetings To : \033[36mBlck\033[92mHrtz
                                     """)
	slowprint("\n\t\t\t\t\tPowered By : Site Tester by BlckHrtz" + "\n\t\t\t\t\t\tFacebook : facebook.com/blck.hrtz.12")
	print("")
	print("""
        \033[91m[0] \033[93mBot Upload Shells!
        
        \033[91m[1] \033[95mGrabb Sites \033[96m From Zone-h.org
        \033[91m[2] \033[95mGrabb Sites \033[96m From Br.Zone-h.org
        
        \033[91m[3] \033[95mGrabb Sites \033[96m From mirror-h.org
        \033[91m[4] \033[95mGrabb Sites \033[96m From aljyyosh.org.com ~_*
        
        \033[91m[5] \033[95mGet Sites bypass With List [Bypass Finder]
        \033[91m[6] \033[95mMass Add (http://) To List
        \033[91m[7] \033[95mGrabber Sites From Bing :P
        \033[91m[8] \033[95mCms Filtre
        \033[91m[9] \033[95mEmail Valid Spotify
        
                    \033[37m#######################################################
                    #              \033[31m\033[1mLove 4 India \033[97m||  \033[92m\033[1mLive 4 India          \033[37m#
                    \033[37m#######################################################
			""")		
	try:
		qq = int(raw_input("\033[91m[-] \033[90mroot@BH~# \033[33mChoose Section !!\033[95m : \033[90m"))
		if qq == 0:
			clearscrn()
			print(banner)
			botv1()
